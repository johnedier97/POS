# validacion-cierre-diario-caja

## Purpose

Forzar el arqueo diario de caja bloqueando el acceso al POS y la creación de nuevas ventas cuando la sesión de caja abierta fue iniciada en un día anterior al actual.
