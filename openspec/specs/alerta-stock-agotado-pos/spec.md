# alerta-stock-agotado-pos

## Purpose

Notificar visualmente al cajero cuando un producto está agotado en el módulo POS, bloqueando su adición al carrito y cargando el inventario de forma eficiente (una sola consulta batch).
