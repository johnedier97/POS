...
Índices y restricciones de base de datos para optimizar consultas frecuentes en las tablas `sales`, `cash_register_sessions` e `inventories`, incluyendo índices compuestos, índices simples y restricciones únicas para evitar full table scans.
