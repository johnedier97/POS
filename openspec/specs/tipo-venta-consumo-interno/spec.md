# tipo-venta-consumo-interno

## Purpose

Permitir registrar transacciones de tipo "consumo interno" (ej. consumo de empleados, degustaciones) en el módulo POS. Estas transacciones descuentan inventario pero no requieren pagos, no afectan el arqueo de caja ni los KPIs del dashboard, y se distinguen visualmente de las ventas normales y las novedades/mermas.
