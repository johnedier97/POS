...
Sistema de caché con Redis para las estadísticas del dashboard (`todaySales`, `inventoryAlerts`, `activeRegisters`), almacenando resultados con un TTL de 60 segundos mediante `Cache::remember()` y configurando `CACHE_STORE=redis` como driver.
