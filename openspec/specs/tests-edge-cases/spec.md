...
Tests de casos extremos que cubren stock negativo, productos compuestos con anidación profunda, precisión decimal en cálculos monetarios, ventas tipo merma (waste), e integridad de constraints UNIQUE en inventarios.
