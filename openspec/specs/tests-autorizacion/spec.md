...
Tests que validan el middleware CheckRole y la protección de rutas administrativas, asegurando que usuarios con rol admin acceden a rutas protegidas mientras que usuarios sin el rol o no autenticados son bloqueados.
